...
const RESERVED = new Set([
    ...
    "attached", "detached", "destroy", "draw", "get", "set", "bool",
    "props", "overrides", "node", "nodes", "self", "controller",
    "needsDisplay", "bindEvents", "isAttached", "listeners", "vtree",
]);
...
function declaredSettings(type) {
    const chain = [];
    for (let t = type; t && t !== Function.prototype; t = Object.getPrototypeOf(t)) {
        if (Object.prototype.hasOwnProperty.call(t, "props")) chain.unshift(t.props);
    }
