...
//
// The Java version built a `data:` URL by hand —
// `"data:text/plain;charset=utf-8," + URL.encode(text)` — which works and has
// one limit worth caring about: the file is the address, so the whole document
// travels percent-encoded, and browsers cap how long an address may be. A
// document over a few megabytes is a download that quietly does not happen.
//
...
// shim — the Java form still works, and is what this falls back to.
