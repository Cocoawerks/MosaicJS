...
export default class ColorWell extends Button {
  ...
  across(side, box) {
    ...
    if (middle < window.innerWidth * 0.4)
      return PopOverOrientation[`${side}_LEFT`];
    if (middle > window.innerWidth * 0.6)
      return PopOverOrientation[`${side}_RIGHT`];
  ...
  down(side, box) {
    ...
    if (middle < window.innerHeight * 0.4)
      return PopOverOrientation[`${side}_TOP`];
    if (middle > window.innerHeight * 0.6)
      return PopOverOrientation[`${side}_BOTTOM`];
